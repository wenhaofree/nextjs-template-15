        ...
        <div className="mt-8 space-y-4">
          ...
          {process.env.NEXT_PUBLIC_AUTH_WECHAT_ENABLED === "true" && (
            <button
              ...
              disabled={!!loading}
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-300 rounded-lg text-sm font-medium bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#07C160] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Image
                    src="/wechat.svg"
                    alt="WeChat"
                    ...
                    height={16}
                  />
              {loading === 'WeChat' ? t('signingIn') : t('signInWithWechat')}
