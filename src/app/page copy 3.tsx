    ...
    <div className="min-h-screen bg-black text-white font-sans relative">
      ...
      <div id="goals-container" className="absolute bottom-0 left-0 right-0 min-h-screen flex flex-col justify-end pb-32 px-6">
        <div className="space-y-4">
          <h2 className="text-2xl font-medium mb-6">小熊的2025目标</h2>
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg">健康</h3>
                </div>
                <p className="text-gray-400 text-sm leading-tight">(健康与快乐)</p>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg">个人</h3>
                </div>
                <p className="text-gray-400 text-sm leading-tight">(自信与人际关系)</p>
                <ul className="space-y-0.5">
                  <li className="flex items-center gap-2">
                    <span>□</span>
                    <span>结识50个新朋友</span>
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg">财富</h3>
                </div>
                <p className="text-gray-400 text-sm leading-tight">(财务自由)</p>
                <ul className="space-y-0.5">
                  <li className="flex items-center gap-2">
                    <span>□</span>
                    <span>收入上限</span>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg">工作</h3>
                </div>
                <p className="text-gray-400 text-sm leading-tight">(商业自信的设计师)</p>
                <ul className="space-y-0.5">
                  <li className="flex items-center gap-2">
                    <span>□</span>
                    <span>发布1个解决问题的产品</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span>□</span>
                    <span>邮件列表达到1万人</span>
